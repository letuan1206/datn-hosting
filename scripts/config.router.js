...
(function () {
  ...
  config.$inject = ['$stateProvider', '$urlRouterProvider', 'MODULE_CONFIG', '$locationProvider', 'toastrConfig', 'vcRecaptchaServiceProvider'];
  function config($stateProvider, $urlRouterProvider, MODULE_CONFIG, $locationProvider, toastrConfig, vcRecaptchaServiceProvider) {
